...
$(document).ready(function() {
    ...
    listaServiciosBody.on('click', '.btnEditar', function() { /* ... Tu código de editar servicio ... */ });
    listaServiciosBody.on('click', '.btnEliminar', function() { /* ... Tu código de eliminar servicio ... */ });
    ...
    listaQABody.on('click', '.btnEditarQA', function() {
        ...
        $.ajax({
            ...
            error: (xhr) => { showMessage('error', 'Error al cargar datos de P/R.'); console.error(xhr); },
            complete: () => { showLoading(false); }
        });
    });
